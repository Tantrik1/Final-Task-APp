-- ============================================================================
-- MANUAL SETUP FOR OPTIMIZED TIMER SYSTEM
-- ============================================================================
-- Run this script in your Supabase SQL Editor

-- 1. Create optimized timer toggle function
...
-- 2. Create optimized stop timer function
...
-- 3. Grant permissions
GRANT EXECUTE ON FUNCTION public.toggle_task_timer_optimized TO authenticated;
GRANT EXECUTE ON FUNCTION public.stop_task_timer_optimized TO authenticated;
